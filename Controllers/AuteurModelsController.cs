...
namespace MVCLibraryApp.Controllers
{
    public class AuteurModelsController : Controller
    {
        ...
        public IActionResult CreateAuteur()
        {
            return View();
        }
        ...
        public async Task<IActionResult> CreateAuteur(AuteurViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Dashboard", "YourControllerName");
            }
